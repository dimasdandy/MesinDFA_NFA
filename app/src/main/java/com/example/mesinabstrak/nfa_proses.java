...
public class nfa_proses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfa_proses);
    ...
    public void fungsiNFA (String hasil){
    ...
    public void onBackPressed() {
        Intent awal = new Intent(nfa_proses.this, nfa.class);
        startActivity(awal);
        finish();
        super.onBackPressed();
    }
